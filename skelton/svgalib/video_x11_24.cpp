...
Video_X11_24::Video_X11_24(int w, int h, const char *wname, Display* dpy,
                           Visual* vis):
  Video_X11(w, h, wname, dpy, vis, 24) {
...
void Video_X11_24::dosetpal(const PALETTEENTRY pal[256], int size) {
  int i;
